package com.example.ayufpjobsheet16
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val biodata = arrayOf("AYU FEBRIANA PUTRI", "XI PPLG 2", "2977")
        ...
        btn2.setOnClickListener {
            ...
            val dialoglayout = inflater.inflate(R.layout.fragment_activity_dialog, null)
